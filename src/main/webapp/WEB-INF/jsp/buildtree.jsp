...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-sm-8 col-xs-12 col-md-offset-3 col-sm-offset-2">
            <div class="register-form">
                ...
                <p class="hint-text">You have to add the father of the exact previous generation, where you have left!
                    if you didn't have added anyone, then add your father in the form!</p>
                <br>
                <div class="row">
    ...
    <div class="row">
        <div class="col-md-4 col-xs-12">
            <div class="form-group">
                <input type="submit" value="Submit" class="btn btn-primary btn-block btn-lg" style="margin-left: 200%" tabindex="8">
            </div>
        </div>
    </div>
    </spring:form>
